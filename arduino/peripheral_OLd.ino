...
// // Characteristics
// BLEStringCharacteristic controlChar("2100", BLERead | BLEIndicate | BLEWrite, 128);
// BLEStringCharacteristic statusChar("2101", BLERead | BLEIndicate, 32);
...
//       controlChar.writeValue(generateChallenge());
